...
export default function Home() {
  ...
  const floatingCardsMobile = [
    { slug: "bookee", gi: featuredIndexBySlug.bookee ?? 0, ix: 14, iy: 20, dx: -2, dy: 24, r: -7, w: 110, h: 148 },
    { slug: "petcard", gi: featuredIndexBySlug.petcard ?? 2, ix: 84, iy: 8, dx: 0, dy: 56, r: 6, w: 100, h: 158 },
    { slug: "notion-client-intake", gi: featuredIndexBySlug["notion-client-intake"] ?? 3, ix: 90, iy: 62, dx: 0, dy: 78, r: 3, w: 112, h: 112 },
    { slug: "reelwish", gi: featuredIndexBySlug.reelwish ?? 5, ix: 10, iy: 82, dx: 0, dy: -48, r: -3, w: 126, h: 94 },
