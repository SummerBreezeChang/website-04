...
export const projects: ProjectMeta[] = [
  ...
  // ═══ REELWISH ═══ 6 sections: problem → tension(callout) → gesture map(flow) → process(flow) → prototype(image-grid) → decisions(cards)
  {
    ...
    thumbnail:"/projects/reelwish/thumb.png",heroImage:"Front-camera gesture capture — joy / surprise / support / connection reactions animating in real time for viewer and creator",
